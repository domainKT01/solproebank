...
@section('content')
    <div class="card">
        <div class="card_body">
            {!! Form::open(['route' => 'admin.requestorings.store', 'autocomplete' => 'on']) !!}
            ...
            <div class="form-row ml-4 mt-2">
                <div class="form-group ">
                    ...
                    {!! Form::select('ID_STATE', $estados, null, ['placeholder'=>'Choose state','ID_STATE'=>'STATE','class' => 'form-control']) !!}
                    @error('ID_STATE')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group col-md-4 ">
                    ...
                    {!! Form::select('CODIGO', $municipios, null, ['placeholder'=>'Choose towns','ID_STATE'=>'STATE','class' => 'form-control']) !!}
                    @error('codigo')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
