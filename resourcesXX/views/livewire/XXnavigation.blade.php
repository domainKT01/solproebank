    ...
    <div class="relative flex items-center justify-between h-16">
      ...
      <div class="flex items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <a href="/" class="flex-shrink-0 flex items-center ">
          <div class="logo p-2">
              <img class="block lg:hidden h-12 w-24 brand-image img elevation-3" src="vendor/adminlte/dist/img/Solproe.png" width="100%" alt="Solproe.SAS">
              <img class="hidden lg:block h-12 w-24 brand-image img elevation-3" src="vendor/adminlte/dist/img/Solproe.png" width="100%" alt="Solproe.SAS">
          </div> 
        </a>
        <!-- End of Logo-->
