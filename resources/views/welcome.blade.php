    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                ...
                <a href="{{ route('dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Login</a>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
           ...
           {{--<div class="justify-center ">
                    <img class="block lg:h-1  " src="vendor/adminlte/dist/img/Solproe.png" width="100%" alt="Solproe.SAS">
                    <img class="hidden lg:block  " src="vendor/adminlte/dist/img/Solproe.png" width="100%" alt="Solproe.SAS">
            </div>--}}
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="#"
                                    class="underline text-gray-900 dark:text-white">SOLPROE - BLOODBANK</a></div>
                        </div>
