    ...
    <div class="max-w-lg max-w-xs rounded-lg mx-auto text-center py-12 mt-4 rounded-xl">
        ...
        <div class="container py-5 max-w-md mx-auto">
            <form method="POST" action="{{ route('forms') }}">
                ...
                <button type="submit" style="color: black;" class="shadow appearance-none  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" aria-label="Default select example">Ingresar</button>
            </form>
        </div>
    </div>
@stop
